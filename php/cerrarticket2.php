...
if (
    ...
    if ($extension == 'jpg' || $extension == 'png') {
            if ($fila = $resultado->fetch_assoc()) {
                ...
                header("Location: ../mistickets.php?error=No se encontró el usuario");
            }
    } else {
        header("Location: ../mistickets.php?error=El formato de imagen no es válido (solo se permiten JPG y PNG)");
    }
} else {
