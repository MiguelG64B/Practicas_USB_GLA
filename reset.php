        ...
        <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
          <div class="card z-index-0">
            <div class="card-header text-center pt-4">
              <h5>Ingresa tu Codigo</h5>
            </div>
            <div class="card-body">
              <form role="form" class="needs-validation" method="post" action="./php/verificartoken.php">
                <div class="mb-3">
                ...
                <div class="text-center">
                  <button type="submit" class="btn bg-gradient-dark w-100 my-4 mb-2">Validar codigo</button>
                </div>
                <?php
