...
tickets 
inner join categorias on tickets.id_categoria = categorias.id") or die($conexion->error);
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            if ($f['id_estado'] == 3 || $f['id_estado'] == 4) {
                              ...
                              $botonDetalles = '<button class="btn btn-primary btn-small btndetalles2" title="Ver detalles"  data-id="' . $f['id_ticket'] . '" data-categoria="' . $f['id_categoria'] . '" data-prioridad="' . $f['id_prioridad'] . '" data-encargado="' . $f['id_encargado'] . '" data-titulo="' . $f['titulo'] . '" data-editor="' . htmlspecialchars($f['resumen']) . '" data-toggle="modal" data-target="#modalDetalles2"><i class="fa fa-eye"></i></button>';
                            }
                            ...
                            if ($f['id_encargado'] == $idUsuario) {
                              // Mostrar el botón de editar solo si el id_usuario coincide con $idUsuario
                            ?>
                              <button class="btn btn-danger btn-small btncerrar" title="Cerrar ticket"  data-id="<?php echo $f['id_ticket']; ?>" data-id_usuario="<?php echo $f['id_usuario']; ?>" data-toggle="modal" data-target="#modalcerrar">
          ...
          <form action="./php/cerrarticket.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="modal-body">
              ...
              <div class="form-group">
                ...
                <textarea name="editor" id="editorcerrar" class="form-control editorEdit2" required></textarea>
              </div>
              <div class="form-group">
